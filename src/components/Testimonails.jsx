...
const Testimonails = () => {
  return (
    <div className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonails'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from  Thosse whoe Found Home with Us</p>

        <div className='flex flex-wrap justify-center gap-8'> 
            {testimonialsData.map((testimonails, index)=>(
                <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
                    <img src={testimonails.image} alt={testimonails.alt} className='w-20 h-20 rounded-full mx-auto mb-4'/>
