...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 ư-full
    overflow-hidden' id='Projects'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Projects <span
        className='underline underline-offset-4 decoration-1 font-light'>Completed</span></h1>
        ...
        <div className='flex items-center justify-end mb-8'>
            ...
            className='p-3 bg-gray-200 rounded mr-2' aria-label='Nexr Project'>
