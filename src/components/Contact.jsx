...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "f2b806c3-22f8-43e6-8cdb-3aa8c3815687");
        ...
        <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8">
            <div className="flex flex-wrap">
                ...
                <div className="w-full md:w-1/2 text-left md:pl-4">
                    Your Email
                    <input name="Email" className="w-full border border-gray-300 rounded py-3 px-4 mt-2" type="text" placeholder="Your Email" required/>
                </div>
            </div>
            <div className="my-6 text-left">
                Message
                <textarea className="w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 resize-none"
                name="Massage" placeholder="Message" id="" required></textarea>
            </div>
